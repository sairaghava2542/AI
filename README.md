 ...
 ## to connect power/ground_nets
      ...
      create_pg_ring_pattern core_ring_pattern -horizontal_layer M7 -horizontal_width 2.0 -horizontal_spacing 2.0 -vertical_layer M8 -vertical_width 2.0 -vertical_spacing 2.0
     set_pg_strategy core_power_ring -core -pattern {{name : core_ring_pattern}{nets : {VDD VSS}}{offset : {2 2}}}
     compile_pg -strategies core_power_ring
     create_pg_mesh_pattern mesh -layers { {{vertical_layer: M6}{width: 1} {spacing: interleaving}{pitch: 10} {offset: 1}} {{horizontal_layer: M7}{width: 1} {spacing: interleaving} {pitch: 10} {offset: 1}} {{vertical_layer: M8}{width: 1} {spacing: interleaving}{pitch: 10} {offset: 1}}}
